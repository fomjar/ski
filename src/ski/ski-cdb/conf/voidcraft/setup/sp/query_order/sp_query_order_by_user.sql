...
begin
    ...
    declare c_pass_curr varchar(32);
    ...
    declare rs          cursor for
                        select p.i_pid, p.i_prod_type, p.c_prod_name, p.i_prod_inst, ga.c_user, ga.c_pass_curr, ga.c_pass_a, ga.c_pass_b
    ...
    open rs;  
    /* 逐个取出当前记录i_gaid值*/
    fetch rs into i_pid, i_prod_type, c_prod_name, i_prod_inst, c_user, c_pass_curr, c_pass_a, c_pass_b;
    /* 遍历数据表 */
    repeat
