...
delete from tbl_game_account_game;
delete from tbl_game;
delete from tbl_order;
delete from tbl_order_product;

insert into tbl_game_account(i_gaid, c_user, c_pass_cur, c_pass_a, c_pass_b) values (1, 'user1', 'pass_cur_1', 'pass_a_1', 'pass_b_1');
insert into tbl_game_account(i_gaid, c_user, c_pass_cur, c_pass_a, c_pass_b) values (2, 'user2', 'pass_cur_2', 'pass_a_2', 'pass_b_2');
insert into tbl_game_account(i_gaid, c_user, c_pass_cur, c_pass_a, c_pass_b) values (3, 'user3', 'pass_cur_3', 'pass_a_3', 'pass_b_3');

insert into tbl_game_account_game(i_gaid, i_gid) values (1, 1);
insert into tbl_game_account_game(i_gaid, i_gid) values (2, 2);
insert into tbl_game_account_game(i_gaid, i_gid) values (3, 3);

insert into tbl_game(i_gid, c_name_cns) values (1, "刺客信条1");
insert into tbl_game(i_gid, c_name_cns) values (2, "刺客信条2");
insert into tbl_game(i_gid, c_name_cns) values (3, "刺客信条3");

insert into tbl_order(c_poid, i_coid, i_channel, c_caid, t_place) values ('abcd12345', 12345, 0, "orojewptk3o2cyrlsxuux-fuypbm", now());

insert into tbl_order_product(c_poid, i_pid, i_prod_type, c_prod_name, i_prod_price, i_state, c_take_info, i_inst_type, i_inst_id, t_return_apply, t_return_done, i_refund)
                    values('abcd12345', 1, 0, '刺客信条1账号租赁A', 1.5, 1, '提取码abc', 1, 1, now(), now(), 30.5);
insert into tbl_order_product(c_poid, i_pid, i_prod_type, c_prod_name, i_prod_price, i_state, c_take_info, i_inst_type, i_inst_id, t_return_apply, t_return_done, i_refund)
                    values('abcd12345', 2, 0, '刺客信条2账号租赁A', 1.6, 1, '提取码def', 2, 2, now(), now(), 20.5);
insert into tbl_order_product(c_poid, i_pid, i_prod_type, c_prod_name, i_prod_price, i_state, c_take_info, i_inst_type, i_inst_id, t_return_apply, t_return_done, i_refund)
                    values('abcd12345', 3, 0, '刺客信条3账号租赁A', 1.7, 1, '提取码ghi', 3, 3, now(), now(), 40.5);
