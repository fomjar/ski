delete from tbl_cmd_map where i_cmd = (conv(00002104, 16, 10) + 0);
insert into tbl_cmd_map values((conv(00002104, 16, 10) + 0), 'sp', 2, "sp_unlock_account_return(?, ?, $i_inst_id, $'c_caid')");

drop procedure if exists sp_unlock_account_return;
DELIMITER //
create procedure sp_unlock_account_return (
