...
label_pro:BEGIN
    ...
    select i_rent into i_state_before from tbl_game_account_rent where i_gaid = in_i_gaid;

    if(i_rent <> 22 ) && (i_rent <> 1) then
