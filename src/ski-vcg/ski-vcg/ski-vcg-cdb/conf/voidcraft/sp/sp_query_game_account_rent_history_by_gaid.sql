delimiter //
drop procedure if exists sp_query_game_account_rent_history_by_gaid //
create procedure sp_query_game_account_rent_history_by_gaid (
    out i_code  integer,
...
begin
    ...
    declare rs          cursor for
                        select gar.i_gaid, gar.i_type, gar.i_caid, gar.i_state, gar.t_change
                          from tbl_game_account_rent_history gar
                         where gar.i_gaid = gaid
                         order by gar.t_change desc;
