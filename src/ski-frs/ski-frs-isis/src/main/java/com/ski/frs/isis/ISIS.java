...
public class ISIS {
    ...
    public static final int INST_UPDATE_SUB_MAN         = 0x00001004;
    public static final int INST_UPDATE_SUB_MAN_PIC     = 0x00001005;
    ...
    public static final int INST_QUERY_SUB_MAN          = 0x00002012;
    public static final int INST_QUERY_SUB_MAN_PIC      = 0x00002013;
