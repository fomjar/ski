...
function build_body_l() {
    ...
    frs.ui.body().l.append([
        ...
        $('<label>车牌</label>'), $("<input placeholder='车牌号' type='text'>"),
        $('<label>型号</label>'), $("<select><option>不限</option><option>宝马</option><option>奔驰</option><option>大众</option><option>其它</option></select>"),
